...
const TestimonialCarousel = dynamic(() => import('@/features/home/components/TestimonialCarousel'), {
  ssr: false,
  loading: () => (
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      <Hero
        title="Your Agency's Web Development Partner"
        subtitle="Austin-based team building fast, custom websites your clients can manage themselves — plus performance optimization, WordPress support, and maintenance. White-label, with quick turnarounds starting at $50/hour."
        actions={[
          {
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-primary/70 max-w-3xl mx-auto">
              Real websites we&apos;ve designed and built — custom sites, e-commerce, and lead-generation sites
            </p>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="group relative">
                  ...
                  <div className="relative flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-nebula-purple dark:text-nebula-white mb-2 transition-colors duration-300 group-hover:text-nebula-violet dark:group-hover:text-nebula-cyan">
                        <Link href="/white-label-web-development" className="hover:underline">
                          True White-Label Partnership
                        </Link>
                      </h3>
                      <p className="text-text-primary/70 transition-colors duration-300 group-hover:text-text-primary/90">
                        Your clients never know we exist unless you want them to. <Link href="/white-label-web-development" className="text-nebula-cyan hover:underline">Learn more about our white-label services</Link>.
                      </p>
                    </div>
                  </div>
                </div>
