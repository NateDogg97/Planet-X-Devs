...
import RetainerPlanCard from '@/features/services/components/RetainerPlanCard';
      ...
      <Section container className="relative" background='dark' spacing='medium'>
        ...
        <div className="max-w-3xl relative z-10">
          ...
          <p className="text-xl text-nebula-white/80">
            White-label development partnerships that make your agency look great. From custom builds to React apps to ongoing support, we've got the technical expertise you need.
          </p>
        </div>
      </Section>
