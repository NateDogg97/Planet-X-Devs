      ...
      <Section container background="secondary" className="relative">
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2 space-y-12 pr-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-text-primary mb-4">
                4. WordPress Support & Migrations
              </h3>
              <h4 className="text-xl font-semibold text-text-primary mb-4">Deep WordPress Expertise for the Sites You Already Manage</h4>
              <div className="px-6 border-l-2 border-nebula-violet">
                <p className="text-text-primary mb-4">
                  We lead with modern, custom builds — but WordPress still powers a huge share of the web, and it's one of our native languages. We no longer take on new WordPress builds; instead, we put that deep expertise to work supporting, optimizing, and migrating the WordPress sites your agency already manages.
                </p>
                <p className="text-text-primary mb-4">
                  Our WordPress support services include performance optimization and Core Web Vitals improvements, security hardening and malware cleanup, plugin and theme troubleshooting, ongoing maintenance and updates, WooCommerce support, and seamless migrations — whether you're moving a site between hosts or off WordPress entirely onto a faster custom build.
                </p>
                <p className="text-text-primary">
                  We're fluent across the WordPress ecosystem — Gutenberg, Advanced Custom Fields (ACF), and the major page builders (Elementor, Divi, Beaver Builder) — so we can jump into an existing site and make it faster and more secure without a rebuild. And when a client outgrows WordPress, we can migrate their content to a modern, custom, easy-to-manage site with zero downtime.
                </p>
              </div>
            </div>
