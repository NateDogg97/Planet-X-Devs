...
import ImagePlaceholder from '@/features/portfolio/components/ImagePlaceholder';
import ProjectGallery, { type GallerySlide } from '@/features/portfolio/components/ProjectGallery';
