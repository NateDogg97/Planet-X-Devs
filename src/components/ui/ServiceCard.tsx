...
export default function ServiceCard({ title, description, icon }: ServiceCardProps) {
  return (
    <div className="relative group h-full">
      ...
      <div className="relative glass-violet shadow-nebula rounded-2xl p-8 text-center hover:-translate-y-2 transition-all duration-300 will-change-transform h-full flex flex-col">
