...
import TabsView, { TabItem } from './TabsView';
...
function Tabs(props: TabsProps) {
  return (
    <Suspense fallback={<TabsFallback tabs={props.tabs} defaultActiveTab={props.defaultActiveTab} className={props.className} />}>
      <TabsView {...props} />
    </Suspense>
  );
}

function TabsFallback({ tabs, defaultActiveTab, className }: Pick<TabsProps, 'tabs' | 'defaultActiveTab' | 'className'>) {
