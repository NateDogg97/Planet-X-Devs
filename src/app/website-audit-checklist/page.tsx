...
export const metadata: Metadata = {
  ...
  description: 'Use our 30-point website audit checklist to find issues affecting your speed, security, SEO, and conversions. Get personalized recommendations.',
  ...
  openGraph: {
    ...
    description: 'Use our 30-point website audit checklist to find issues affecting your speed, security, SEO, and conversions.',
    type: 'website',
  },
  twitter: {
